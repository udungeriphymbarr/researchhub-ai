      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="mt-6 text-lg text-gray-600 max-w-3xl mx-auto">
            ResearchHub AI is designed to help students, lecturers and
            researchers complete projects faster with the assistance of
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((item, index) => (
            ...
            >
              ...
              <p className="text-gray-600 leading-8 italic">"{item.quote}"</p>

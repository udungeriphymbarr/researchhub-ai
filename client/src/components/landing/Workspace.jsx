      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="mt-6 max-w-3xl mx-auto text-lg text-gray-600">
            Stop switching between notebooks, Word documents, ChatGPT, browsers,
            and folders. Everything you need lives inside one dashboard.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white p-6 flex justify-between items-center">
            <div>
              <h3 className="text-2xl font-bold">ResearchHub Dashboard</h3>

              <p className="opacity-80">AI Workspace</p>
            </div>

            <div className="bg-green-500 px-4 py-2 rounded-full">Premium</div>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 p-8">
            ...
            <Card icon={<FaBookOpen />} title="Chapter Outline" color="cyan" />

            <Card icon={<FaFolderOpen />} title="Projects" color="green" />

            <Card icon={<FaHistory />} title="History" color="orange" />

            <Card icon={<FaCrown />} title="Premium AI" color="purple" />
          </div>
        </motion.div>
      </div>
    </section>

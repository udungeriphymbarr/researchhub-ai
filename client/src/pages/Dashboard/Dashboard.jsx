...
import { FaFolderOpen, FaBook, FaQuestionCircle, FaProjectDiagram,} from "react-icons/fa";
  ...
  <div className="relative z-10 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8">
    ...
    <div>
      ...
      <p className="mt-5 max-w-xl text-white/90 leading-7">
        ...
        Continue building your research project,
        generate academic content,
        manage your purchased books,
        and complete your work faster with AI.

...
function Methodology() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8">
      <h1 className="text-3xl font-bold mb-2">AI Methodology Generator</h1>
      ...
      <div className="bg-white p-6 rounded-xl shadow max-w-4xl">
        ...
        >
          {loading ? "Generating..." : "Generate Methodology"}
        </button>
      </div>
      ...
      {content && (
        <div className="bg-white p-6 rounded-xl shadow mt-8">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-semibold">Generated Methodology</h2>

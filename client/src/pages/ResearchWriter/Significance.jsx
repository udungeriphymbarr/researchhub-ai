...
function Significance() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8">
      <h1 className="text-3xl font-bold mb-2">AI Significance Generator</h1>

      <p className="text-gray-500 mb-8">
        Generate research significance from your topic.
      </p>
      ...
      <div className="bg-white p-6 rounded-xl shadow max-w-4xl">
        ...
        <button
          onClick={generateSignificance}
          disabled={loading}
          className="bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 disabled:bg-gray-400"
        >
          {loading ? "Generating..." : "Generate Significance"}
        </button>
      </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow mt-8">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-semibold">
              Generated Significance of the Study
            </h2>
